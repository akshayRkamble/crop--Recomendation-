...
class EconomicAnalyzer:
    def __init__(self):
        self.crop_economics = {
            'rice': {'cost_per_hectare': 35000, 'avg_yield': 4.5, 'price_per_kg': 25},
            'maize': {'cost_per_hectare': 30000, 'avg_yield': 6.0, 'price_per_kg': 18},
            'cotton': {'cost_per_hectare': 45000, 'avg_yield': 3.0, 'price_per_kg': 60},
            'wheat': {'cost_per_hectare': 35000, 'avg_yield': 4.0, 'price_per_kg': 28},
            'sugarcane': {'cost_per_hectare': 55000, 'avg_yield': 75.0, 'price_per_kg': 3.5},
            'coffee': {'cost_per_hectare': 65000, 'avg_yield': 2.5, 'price_per_kg': 120},
            'banana': {'cost_per_hectare': 70000, 'avg_yield': 30.0, 'price_per_kg': 15},
            'apple': {'cost_per_hectare': 80000, 'avg_yield': 18.0, 'price_per_kg': 45},
            'orange': {'cost_per_hectare': 60000, 'avg_yield': 20.0, 'price_per_kg': 30},
            'mango': {'cost_per_hectare': 75000, 'avg_yield': 15.0, 'price_per_kg': 40},
            'chickpea': {'cost_per_hectare': 25000, 'avg_yield': 2.0, 'price_per_kg': 70},
            'pigeonpeas': {'cost_per_hectare': 23000, 'avg_yield': 1.8, 'price_per_kg': 75},
            'mothbeans': {'cost_per_hectare': 22000, 'avg_yield': 1.7, 'price_per_kg': 80},
            'mungbean': {'cost_per_hectare': 28000, 'avg_yield': 1.9, 'price_per_kg': 90},
            'blackgram': {'cost_per_hectare': 26000, 'avg_yield': 2.0, 'price_per_kg': 85},
            'lentil': {'cost_per_hectare': 30000, 'avg_yield': 2.2, 'price_per_kg': 80},
            'pomegranate': {'cost_per_hectare': 110000, 'avg_yield': 18.0, 'price_per_kg': 55},
            'grapes': {'cost_per_hectare': 140000, 'avg_yield': 22.0, 'price_per_kg': 50},
            'watermelon': {'cost_per_hectare': 55000, 'avg_yield': 40.0, 'price_per_kg': 10},
            'muskmelon': {'cost_per_hectare': 50000, 'avg_yield': 35.0, 'price_per_kg': 12},
            'papaya': {'cost_per_hectare': 70000, 'avg_yield': 45.0, 'price_per_kg': 18},
            'coconut': {'cost_per_hectare': 90000, 'avg_yield': 15000, 'price_per_kg': 18},
            'jute': {'cost_per_hectare': 35000, 'avg_yield': 3.0, 'price_per_kg': 35},
            'kidneybeans': {'cost_per_hectare': 28000, 'avg_yield': 2.0, 'price_per_kg': 65},
            'soybean': {'cost_per_hectare': 30000, 'avg_yield': 2.5, 'price_per_kg': 45},
            'peas': {'cost_per_hectare': 32000, 'avg_yield': 2.8, 'price_per_kg': 50},
            'potato': {'cost_per_hectare': 45000, 'avg_yield': 28.0, 'price_per_kg': 15},
            'mustard': {'cost_per_hectare': 28000, 'avg_yield': 1.8, 'price_per_kg': 55},
            'tomato': {'cost_per_hectare': 50000, 'avg_yield': 35.0, 'price_per_kg': 18},
            'onion': {'cost_per_hectare': 55000, 'avg_yield': 28.0, 'price_per_kg': 22},
            'garlic': {'cost_per_hectare': 60000, 'avg_yield': 14.0, 'price_per_kg': 65},
            'turmeric': {'cost_per_hectare': 65000, 'avg_yield': 10.0, 'price_per_kg': 90},
            'ginger': {'cost_per_hectare': 75000, 'avg_yield': 12.0, 'price_per_kg': 80},
            'cucumber': {'cost_per_hectare': 40000, 'avg_yield': 40.0, 'price_per_kg': 12},
            'brinjal': {'cost_per_hectare': 45000, 'avg_yield': 35.0, 'price_per_kg': 18},
            'pepper': {'cost_per_hectare': 50000, 'avg_yield': 18.0, 'price_per_kg': 45},
            'chilli': {'cost_per_hectare': 55000, 'avg_yield': 15.0, 'price_per_kg': 70},
            'cauliflower': {'cost_per_hectare': 40000, 'avg_yield': 28.0, 'price_per_kg': 18},
            'cabbage': {'cost_per_hectare': 35000, 'avg_yield': 35.0, 'price_per_kg': 15}
        }

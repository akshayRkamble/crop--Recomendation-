...
class EconomicAnalyzer:
    def __init__(self):
        self.crop_economics = {
            'rice': {'cost_per_hectare': 35000, 'avg_yield': 5.5, 'price_per_kg': 30},
            'maize': {'cost_per_hectare': 30000, 'avg_yield': 7.0, 'price_per_kg': 22},
            'cotton': {'cost_per_hectare': 45000, 'avg_yield': 3.5, 'price_per_kg': 70},
            'wheat': {'cost_per_hectare': 35000, 'avg_yield': 4.5, 'price_per_kg': 32},
            'sugarcane': {'cost_per_hectare': 55000, 'avg_yield': 85.0, 'price_per_kg': 4.0},
            'coffee': {'cost_per_hectare': 65000, 'avg_yield': 3.0, 'price_per_kg': 140},
            'banana': {'cost_per_hectare': 70000, 'avg_yield': 35.0, 'price_per_kg': 18},
            'apple': {'cost_per_hectare': 80000, 'avg_yield': 22.0, 'price_per_kg': 50},
            'orange': {'cost_per_hectare': 60000, 'avg_yield': 25.0, 'price_per_kg': 35},
            'mango': {'cost_per_hectare': 75000, 'avg_yield': 18.0, 'price_per_kg': 45},
            'chickpea': {'cost_per_hectare': 25000, 'avg_yield': 2.5, 'price_per_kg': 80},
            'pigeonpeas': {'cost_per_hectare': 23000, 'avg_yield': 2.2, 'price_per_kg': 85},
            'mothbeans': {'cost_per_hectare': 22000, 'avg_yield': 2.0, 'price_per_kg': 90},
            'mungbean': {'cost_per_hectare': 28000, 'avg_yield': 2.2, 'price_per_kg': 100},
            'blackgram': {'cost_per_hectare': 26000, 'avg_yield': 2.3, 'price_per_kg': 95},
            'lentil': {'cost_per_hectare': 30000, 'avg_yield': 2.5, 'price_per_kg': 90},
            'pomegranate': {'cost_per_hectare': 110000, 'avg_yield': 20.0, 'price_per_kg': 60},
            'grapes': {'cost_per_hectare': 140000, 'avg_yield': 25.0, 'price_per_kg': 55},
            'watermelon': {'cost_per_hectare': 55000, 'avg_yield': 45.0, 'price_per_kg': 12},
            'muskmelon': {'cost_per_hectare': 50000, 'avg_yield': 40.0, 'price_per_kg': 15},
            'papaya': {'cost_per_hectare': 70000, 'avg_yield': 50.0, 'price_per_kg': 20},
            'coconut': {'cost_per_hectare': 90000, 'avg_yield': 18000, 'price_per_kg': 20},
            'jute': {'cost_per_hectare': 35000, 'avg_yield': 3.5, 'price_per_kg': 40},
            'kidneybeans': {'cost_per_hectare': 28000, 'avg_yield': 2.3, 'price_per_kg': 75},
            'soybean': {'cost_per_hectare': 30000, 'avg_yield': 3.0, 'price_per_kg': 50},
            'peas': {'cost_per_hectare': 32000, 'avg_yield': 3.2, 'price_per_kg': 55},
            'potato': {'cost_per_hectare': 45000, 'avg_yield': 32.0, 'price_per_kg': 18},
            'mustard': {'cost_per_hectare': 28000, 'avg_yield': 2.2, 'price_per_kg': 60},
            'tomato': {'cost_per_hectare': 50000, 'avg_yield': 40.0, 'price_per_kg': 20},
            'onion': {'cost_per_hectare': 55000, 'avg_yield': 32.0, 'price_per_kg': 25},
            'garlic': {'cost_per_hectare': 60000, 'avg_yield': 16.0, 'price_per_kg': 70},
            'turmeric': {'cost_per_hectare': 65000, 'avg_yield': 12.0, 'price_per_kg': 100},
            'ginger': {'cost_per_hectare': 75000, 'avg_yield': 14.0, 'price_per_kg': 85},
            'cucumber': {'cost_per_hectare': 40000, 'avg_yield': 45.0, 'price_per_kg': 15},
            'brinjal': {'cost_per_hectare': 45000, 'avg_yield': 40.0, 'price_per_kg': 20},
            'pepper': {'cost_per_hectare': 50000, 'avg_yield': 20.0, 'price_per_kg': 50},
            'chilli': {'cost_per_hectare': 55000, 'avg_yield': 18.0, 'price_per_kg': 75},
            'cauliflower': {'cost_per_hectare': 40000, 'avg_yield': 32.0, 'price_per_kg': 20},
            'cabbage': {'cost_per_hectare': 35000, 'avg_yield': 40.0, 'price_per_kg': 18}
        }
